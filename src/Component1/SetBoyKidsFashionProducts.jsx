...
const SetBoyKidsFashion = () => {
  ...
  const setBoyProducts = [
    {
      ...
      tag: "Bestseller",
      sub: "Pure Cotton",
      description: "Comfortable cotton casual set for boys. Includes a stylish t-shirt and matching shorts. Perfect for play dates, family outings, and everyday wear. Soft, breathable, and easy to move in.",
      features: ["100% Pure Cotton", "T-shirt + Shorts", "Comfortable fit", "Machine washable", "Everyday wear"],
      color: "Navy Blue",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp1_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp1_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp1_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp1_4.png"
      ]
    },
    {
      id: 2,
      ...
      tag: "Trending",
      sub: "Pure Linen",
      description: "Lightweight linen summer set for boys. Includes a breathable linen shirt and comfortable shorts. Perfect for vacations, beach days, and warm weather. Keeps your little one cool and stylish.",
      features: ["100% Pure Linen", "Shirt + Shorts", "Breathable fabric", "Summer essential", "Relaxed fit"],
      color: "Beige",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp2_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp2_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp2_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp2_4.png"
      ]
    },
    {
      id: 3,
      ...
      tag: "Popular",
      sub: "Soft Denim",
      description: "Stylish denim casual set for boys. Includes a denim shirt and matching shorts. Durable and comfortable, perfect for active kids who love to explore and play.",
      features: ["100% Cotton Denim", "Shirt + Shorts", "Durable fabric", "Machine washable", "Casual style"],
      color: "Blue Denim",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp3_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp3_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp3_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp3_4.png"
      ]
    },
    {
      id: 4,
      ...
      tag: "Classic",
      sub: "Premium Cotton",
      description: "Elegant cotton party set for boys. Includes a smart shirt and matching trousers. Perfect for weddings, family gatherings, and special occasions. Comfortable and stylish.",
      features: ["100% Premium Cotton", "Shirt + Trousers", "Smart fit", "Special occasions", "Machine washable"],
      color: "White",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp4.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp4_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp4_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp4_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp4_4.png"
      ]
    },
    {
      id: 5,
      name: "Linen Beach Set",
      fabric: "Linen",
      price: 1599,
      oldPrice: 2399,
      rating: 4.4,
      ...
      tag: "New",
      sub: "Pure Linen",
      description: "Relaxed linen beach set for boys. Includes a casual shirt and comfortable shorts. Perfect for beach vacations, summer holidays, and resort wear. Light and breezy.",
      features: ["100% Pure Linen", "Shirt + Shorts", "Lightweight", "Beach essential", "Easy care"],
      color: "Light Blue",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp5.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp5_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp5_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp5_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp5_4.png"
      ]
    },
    {
      id: 6,
      ...
      tag: "Essential",
      sub: "Soft Cotton",
      description: "Comfortable cotton play set for active boys. Includes a printed t-shirt and matching shorts. Perfect for playground, sports, and everyday fun. Soft, stretchable, and durable.",
      features: ["100% Soft Cotton", "T-shirt + Shorts", "Playful print", "Stretchable", "Machine washable"],
      color: "Red",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp6.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp6_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp6_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp6_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp6_4.png"
      ]
    },
    {
      id: 7,
      name: "Denim Style Set",
      fabric: "Denim",
      price: 1999,
      oldPrice: 2999,
      rating: 4.7,
      ...
      tag: "Trending",
      sub: "Soft Denim",
      description: "Stylish denim style set for boys. Includes a denim jacket and matching jeans. Perfect for making a fashion statement. Durable, comfortable, and on-trend.",
      features: ["100% Cotton Denim", "Jacket + Jeans", "Full set", "Fashionable", "Durable"],
      color: "Dark Blue",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp7.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp7_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp7_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp7_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp7_4.png"
      ]
    },
    {
      id: 8,
      name: "Linen Formal Set",
      fabric: "Linen",
      price: 1799,
      oldPrice: 2699,
      rating: 4.6,
      ...
      tag: "Classic",
      sub: "Pure Linen",
      description: "Elegant linen formal set for boys. Includes a smart linen shirt and matching trousers. Perfect for formal events, weddings, and family occasions. Breathable and sophisticated.",
      features: ["100% Pure Linen", "Shirt + Trousers", "Formal style", "Breathable", "Dry clean recommended"],
      color: "Grey",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp8.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp8_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp8_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp8_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp8_4.png"
      ]
    },
    {
      id: 9,
      name: "Cotton Graphic Set",
      fabric: "Cotton",
      price: 1399,
      oldPrice: 2199,
      rating: 4.4,
      ...
      tag: "Popular",
      sub: "Soft Cotton",
      description: "Fun cotton graphic set for boys. Includes a colorful graphic t-shirt and comfortable shorts. Perfect for expressing personality and having fun. Bright, playful, and comfortable.",
      features: ["100% Soft Cotton", "T-shirt + Shorts", "Graphic print", "Vibrant colors", "Machine washable"],
      color: "Yellow",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp9.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp9_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp9_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp9_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp9_4.png"
      ]
    },
    {
      id: 10,
      name: "Denim Adventure Set",
      fabric: "Denim",
      price: 1799,
      oldPrice: 2699,
      rating: 4.5,
      ...
      tag: "Bestseller",
      sub: "Soft Denim",
      description: "Adventure-ready denim set for boys. Includes a rugged denim shirt and cargo shorts. Perfect for outdoor adventures, camping, and exploring. Durable and functional.",
      features: ["100% Cotton Denim", "Shirt + Cargo Shorts", "Adventure style", "Functional pockets", "Durable"],
      color: "Olive",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp10.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp10_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp10_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp10_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp10_4.png"
      ]
    },
    {
      id: 11,
      name: "Linen Vacation Set",
      fabric: "Linen",
      price: 1499,
      oldPrice: 2299,
      rating: 4.3,
      ...
      tag: "New",
      sub: "Pure Linen",
      description: "Relaxed linen vacation set for boys. Includes a striped shirt and comfortable shorts. Perfect for holiday getaways, resort wear, and summer breaks. Effortlessly stylish.",
      features: ["100% Pure Linen", "Striped Shirt + Shorts", "Vacation style", "Lightweight", "Easy care"],
      color: "Blue Stripes",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp11.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp11_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp11_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp11_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp11_4.png"
      ]
    },
    {
      id: 12,
      name: "Cotton School Set",
      fabric: "Cotton",
      price: 1199,
      oldPrice: 1899,
      rating: 4.6,
      ...
      tag: "Essential",
      sub: "Premium Cotton",
      description: "Practical cotton school set for boys. Includes a neat shirt and comfortable trousers. Perfect for school, tuition, and formal events. Smart, comfortable, and durable.",
      features: ["100% Premium Cotton", "Shirt + Trousers", "School style", "Durable fabric", "Machine washable"],
      color: "White & Navy",
      images: [
        "/Fashion/Kids/Boy/Sets/Products/sbkfp12.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp12_1.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp12_2.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp12_3.png",
        "/Fashion/Kids/Boy/Sets/Products/sbkfp12_4.png"
      ]
    }
  ];
  ...
  const filteredProducts = activeFilter === 'all'
    ? setBoyProducts
    : setBoyProducts.filter(p => p.fabric === activeFilter);
        ...
        <section className="relative h-[30vh] md:h-[55vh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end justify-center pb-8 md:pb-20">
            <div className="text-center text-white px-4">
              ...
              <h1 className="text-2xl md:text-5xl lg:text-6xl font-serif font-light tracking-wide">The Boys Set Edit</h1>
              <div className="h-[1px] w-8 md:w-12 bg-amber-400 mx-auto mt-3 md:mt-4 mb-3 md:mb-4"></div>
              <p className="text-xs md:text-base font-light tracking-wide max-w-lg mx-auto">Complete outfits for every occasion</p>
            </div>
          </div>
        </section>
              ...
              <div className="md:w-2/5 p-6 md:p-12 overflow-y-auto flex flex-col bg-[#f4f3f0] md:border-l border-slate-100">
                <div className="mb-auto">
                  <p className="text-orange-700 font-bold text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 md:mb-4">
                    Boys Sets · {selectedProduct.fabric}
                  </p>
...
export default SetBoyKidsFashion;