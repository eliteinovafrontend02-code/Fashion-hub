// PantsMenFashion.jsx - Text Bottom Right Aligned
...
const PantsMenFashion = () => {
  ...
  // Only TWO banners - Jeans and Formal Pants
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Jeans and Formal
  const categories = [
    {
      id: 1,
      title: "Jeans",
  ...
  // Featured Products for Men Pants
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== MEN'S PANTS HERO SECTION - TWO BANNERS (JEANS & FORMAL) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - JEANS & FORMAL ONLY ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Men's Pants Collection</p>
          </div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Comfort Meets <br />
                <span className="italic text-[#8B4513]">Classic Style</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Men</strong>, our pants collection is crafted for the modern gentleman who values both comfort and style. From casual jeans to formal trousers, find your perfect fit.
              </p>

              <p>
                Explore our range of <strong>Comfortable Jeans</strong> and <strong>Elegant Formal Trousers</strong> – designed for all-day comfort and sharp looks.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Premium Quality Pants</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - JEANS & FORMAL PANTS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Premium jeans & formal trousers for every occasion
            </p>
          </div>
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/fashion/men/pants/products">
...
export default PantsMenFashion;