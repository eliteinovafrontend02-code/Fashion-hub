// BoyKidsFashion.jsx - Text Bottom Right Aligned
...
const BoyKidsFashion = () => {
  ...
  // Only TWO banners - Shirts and Sets
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Shirts and Sets
  const categories = [
    {
      id: 1,
      title: "Shirts",
  ...
  // Featured Products for Boy Kids
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== BOY'S KIDS HERO SECTION - TWO BANNERS (SHIRTS & SETS) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - SHIRTS & SETS ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Boy's Fashion Collection</p>
          </div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Little <br />
                <span className="italic text-[#8B4513]">Champion Style</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Kids</strong>, our boy's collection is crafted for little champions who love to play and explore. From smart shirts to comfy sets, find the perfect outfit for your little gentleman.
              </p>

              <p>
                Explore our range of <strong>Stylish Shirts</strong> and <strong>Comfortable Sets</strong> – designed for durability, comfort, and style.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Comfortable & Durable Kids Wear</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - SHIRTS & SETS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Premium shirts & sets for your little champ
            </p>
          </div>
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/fashion/kids/boy/products">
