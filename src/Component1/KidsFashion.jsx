// KidsFashion.jsx - Text Bottom Right Aligned
...
const KidsFashion = () => {
  ...
  // Only TWO banners - Boys and Girls
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Boys and Girls
  const categories = [
    {
      id: 1,
      title: "Boys",
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== KIDS' HERO SECTION - TWO BANNERS (BOYS & GIRLS) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - BOYS & GIRLS WITH SUBCATEGORIES ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Kids' Fashion Essentials</p>
          </div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Playful & <br />
                <span className="italic text-[#8B4513]">Stylish Kids Wear</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Kids</strong>, we bring you premium quality clothing for your little ones. From casual days to special occasions, find the perfect outfit for your child.
              </p>

              <p>
                Explore our range of <strong>Stylish Boy's Shirts & Sets</strong> and <strong>Cute Girl's Frocks & Party Sets</strong> – designed for comfort, durability, and style.
              </p>
            </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - BOYS & GIRLS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Premium kids wear for every occasion
            </p>
          </div>
