// GirlKidsFashion.jsx - Text Bottom Right Aligned
...
const GirlKidsFashion = () => {
  ...
  // Only TWO banners - Frocks and Sets
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Frocks and Sets
  const categories = [
    {
      id: 1,
      title: "Frocks",
  ...
  // Featured Products for Girl Kids
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== GIRL'S KIDS HERO SECTION - TWO BANNERS (FROCKS & SETS) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - FROCKS & SETS ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Girl's Fashion Collection</p>
          </div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Sweet & <br />
                <span className="italic text-[#8B4513]">Charming Style</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Kids</strong>, our girl's collection is crafted for little princesses who love to shine. From cute frocks to stylish sets, find the perfect outfit for your little angel.
              </p>

              <p>
                Explore our range of <strong>Beautiful Frocks</strong> and <strong>Stylish Sets</strong> – designed for comfort, cuteness, and confidence.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Cute & Comfortable Kids Wear</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - FROCKS & SETS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Premium frocks & sets for your little princess
            </p>
          </div>
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/fashion/kids/girl/products">
...
export default GirlKidsFashion;