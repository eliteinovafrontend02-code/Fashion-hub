// DressesWomenFashion.jsx - Text Bottom Right Aligned
...
const DressesWomenFashion = () => {
  ...
  // Only TWO banners - Short Dresses and Long Dresses
  const banners = [
    {
      id: 1,
      image: "/Fashion/Women/Dresses/shortbanner.png",
    ...
    {
      id: 2,
      image: "/Fashion/Women/Dresses/longbanner.png",
  ...
  // Only TWO categories - Short and Long
  const categories = [
    {
      id: 1,
      title: "Short Dresses",
  ...
  // Featured Products for Women Dresses
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== WOMEN'S DRESSES HERO SECTION - TWO BANNERS (SHORT & LONG) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - SHORT & LONG DRESSES ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Women's Dresses Collection</p>
          </div>
      ...
      {/* ====== WOMEN'S DRESSES BRAND NARRATIVE ====== */}
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Modern <br />
                <span className="italic text-[#8B4513]">Feminine Style</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Women</strong>, our dress collection is crafted for the modern woman who loves to express herself. From chic short dresses to elegant long gowns, find your perfect style.
              </p>

              <p>
                Explore our range of <strong>Trendy Short Dresses</strong> and <strong>Graceful Long Dresses</strong> – designed for every occasion, from casual outings to formal events.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="w-full h-full overflow-hidden rounded-[15px] sm:rounded-[20px]">
                <img
                  src="/Fashion/Women/Dresses/dressesbanner.png"
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Premium Quality Dresses</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - SHORT & LONG DRESSES */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-16 bg-[#EAE3DB]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
            {featuredProducts.map((product) => (
              <div key={product.id} className="group flex flex-col">
                ...
                <Link
                  to="/fashion/women/dresses/products"
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/fashion/women/dresses/products">
...
export default DressesWomenFashion;