// FormalPantsMenFashion.jsx - Updated Image Paths
...
const FormalPantsMenFashion = () => {
  ...
  const formalPantsProducts = [
    {
      ...
      reviews: 2345,
      tag: "Bestseller",
      sub: "Premium Wool Blend",
      description: "Timeless black formal trousers in a premium wool blend. The classic design and impeccable tailoring make them essential for any professional wardrobe. Perfect for business meetings and formal events.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Super 120s Wool",
      description: "Sophisticated charcoal grey suit pants crafted from Super 120s wool. The fine fabric and precise tailoring create a sharp, professional look that commands respect in any boardroom.",
    ...
    },
    {
      ...
      reviews: 1567,
      tag: "Classic",
      sub: "Cotton Poly Blend",
      description: "Versatile navy blue dress pants that combine comfort with style. The cotton blend fabric offers breathability while maintaining a crisp, professional appearance. Suitable for office and smart-casual settings.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Pure Linen",
      description: "Breathable beige linen trousers for warm-weather elegance. The pure linen fabric offers exceptional comfort and a relaxed yet refined look. Perfect for summer office wear and outdoor events.",
    ...
    },
    {
      ...
      tag: "Limited",
      sub: "Patterned Wool",
      description: "Distinctive grey checkered trousers for the fashion-forward professional. The subtle check pattern adds character to your formal wardrobe while the premium wool ensures a comfortable fit.",
    ...
    },
    {
      ...
      tag: "Essential",
      sub: "Stretch Cotton",
      description: "Modern black tapered pants with a contemporary silhouette. The tapered leg offers a fresh alternative to traditional dress pants while the stretch cotton ensures all-day comfort.",
    ...
    },
    {
      ...
      reviews: 876,
      tag: "Premium",
      sub: "Herringbone Wool",
      description: "Elegant brown herringbone pattern trousers crafted from premium wool. The intricate herringbone weave adds depth and sophistication, making these pants a standout piece in any formal ensemble.",
    ...
    },
    {
      ...
      tag: "New",
      sub: "Pure Linen",
      description: "Crisp white linen trousers perfect for summer sophistication. The pure linen fabric offers exceptional breathability and a relaxed, elegant drape. Ideal for beach weddings and resort wear.",
    ...
    },
    {
      ...
      tag: "Classic",
      sub: "Pinstripe Wool",
      description: "Classic navy pinstripe trousers that exude old-world elegance. The timeless pinstripe pattern adds a touch of Wall Street sophistication to any formal outfit. A must-have for the discerning professional.",
    ...
    },
    {
      ...
      tag: "Essential",
      sub: "Comfort Cotton",
      description: "Versatile khaki dress pants that work from office to weekend. The comfortable cotton blend fabric and classic design make them a wardrobe staple. Easy to pair with any shirt or blazer.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Super 150s Wool",
      description: "Exquisite charcoal windowpane check trousers from the finest Super 150s wool. The bold windowpane pattern and superior fabric quality make these pants a statement piece for the style-conscious gentleman.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Stretch Fabric",
      description: "Modern slim-fit navy pants with a contemporary edge. The slim silhouette offers a youthful, fashion-forward look while the stretch fabric ensures unrestricted movement. Perfect for the modern professional.",
  ...
  const filters = ['all', 'Wool Blend', 'Cotton Blend', 'Linen'];
  const filteredProducts = activeFilter === 'all'
    ? formalPantsProducts
    : formalPantsProducts.filter(p => p.fabric === activeFilter);
        ...
        <section className="relative h-[30vh] md:h-[55vh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end justify-center pb-8 md:pb-20">
            <div className="text-center text-white px-4">
              <p className="text-amber-300 tracking-[0.2em] text-[8px] md:text-xs mb-2 md:mb-3 font-semibold">12 REFINED PIECES</p>
              <h1 className="text-2xl md:text-5xl lg:text-6xl font-serif font-light tracking-wide">The Formal Edit</h1>
              <div className="h-[1px] w-8 md:w-12 bg-amber-400 mx-auto mt-3 md:mt-4 mb-3 md:mb-4"></div>
              <p className="text-xs md:text-base font-light tracking-wide max-w-lg mx-auto">Elevate your professional wardrobe</p>
            </div>
          </div>
        </section>
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="mt-2 md:mt-3 px-0.5 md:px-1">
                  <p className="text-[7px] md:text-[9px] text-amber-700 uppercase tracking-[0.15em] md:tracking-[0.2em] font-semibold mb-0.5">Formal Pants · {product.fabric}</p>
              ...
              <div className="md:w-2/5 p-6 md:p-12 overflow-y-auto flex flex-col bg-[#f4f3f0] md:border-l border-slate-100">
                <div className="mb-auto">
                  <p className="text-orange-700 font-bold text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 md:mb-4">
                    Formal Pants · {selectedProduct.fabric}
                  </p>
...
export default FormalPantsMenFashion;