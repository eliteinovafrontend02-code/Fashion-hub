// BoyKidsFootwear.jsx - Text Bottom Right Aligned
...
const BoyKidsFootwear = () => {
  ...
  // Only TWO banners - Boy Shoes and Boy Sandals
  const banners = [
    {
      id: 1,
  ...
  // Featured Products for Boy Kids Footwear
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== BOY'S FOOTWEAR HERO SECTION - TWO BANNERS (SHOES & SANDALS) ====== */}
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Boy's Footwear Collection</p>
          </div>
      ...
      {/* ====== BOY'S FOOTWEAR BRAND NARRATIVE ====== */}
        ...
        <div className="max-w-[1400px] w-full grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            ...
            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Boy's Footwear</strong>, we bring you durable and stylish shoes and sandals for your little champions. Designed for active play and everyday comfort.
              </p>

              <p>
                Explore our range of <strong>Sporty Shoes & Casual Sandals for Boys</strong> – crafted with care for growing feet, combining fun designs with lasting quality.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Comfortable & Durable Footwear</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - BOY SHOES & SANDALS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Fun, durable shoes & sandals for every little adventure
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
            {featuredProducts.map((product) => (
              <div key={product.id} className="group flex flex-col">
                ...
                <Link
                  to="/footwear/kids/boy/fproducts"
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/footwear/kids/boy/fproducts">
...
export default BoyKidsFootwear;