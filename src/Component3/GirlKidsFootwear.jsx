// GirlKidsFootwear.jsx - Text Bottom Right Aligned
...
const GirlKidsFootwear = () => {
  ...
  // Only TWO banners - Girl Shoes and Girl Sandals
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Shoes and Sandals
  const categories = [
    {
      id: 1,
      title: "Shoes",
  ...
  // Featured Products for Girl Kids Footwear
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== GIRL'S FOOTWEAR HERO SECTION - TWO BANNERS (SHOES & SANDALS) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - SHOES & SANDALS ONLY ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Girl's Footwear Collection</p>
          </div>
      ...
      {/* ====== GIRL'S FOOTWEAR BRAND NARRATIVE ====== */}
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              <h4 className="text-[#A67C52] font-bold tracking-[0.3em] sm:tracking-[0.5em] uppercase text-[8px] sm:text-[9px]">
                The Girl's Footwear Collection
              </h4>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Little Princess, <br />
                <span className="italic text-[#8B4513]">Big Dreams</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Girl's Footwear</strong>, we bring you adorable and comfortable shoes and sandals for your little princess. Designed for playful days and special occasions.
              </p>

              <p>
                Explore our range of <strong>Pretty Shoes & Cute Sandals for Girls</strong> – crafted with love for growing feet, combining fun designs with lasting quality.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Cute & Comfortable Footwear</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - GIRL SHOES & SANDALS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Cute, comfortable shoes & sandals for every little princess
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
            {featuredProducts.map((product) => (
              <div key={product.id} className="group flex flex-col">
                ...
                <Link
                  to="/footwear/kids/girl/fproducts"
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/footwear/kids/girl/fproducts">
...
export default GirlKidsFootwear;