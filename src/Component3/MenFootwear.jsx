// MenFootwear.jsx - Text Bottom Right Aligned
...
const MenFootwear = () => {
  ...
  // Only TWO banners - Shoes and Sandals
  const banners = [
    {
      id: 1,
  ...
  // Featured Products for Men Footwear
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== MEN'S FOOTWEAR HERO SECTION - TWO BANNERS (SHOES & SANDALS) ====== */}
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Men's Footwear Collection</p>
          </div>
      ...
      {/* ====== MEN'S FOOTWEAR BRAND NARRATIVE ====== */}
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              <h4 className="text-[#A67C52] font-bold tracking-[0.3em] sm:tracking-[0.5em] uppercase text-[8px] sm:text-[9px]">
                The Men's Footwear Collection
              </h4>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Walk with <br />
                <span className="italic text-[#8B4513]">Confidence & Style</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Men's Footwear</strong>, we bring you premium quality shoes and sandals crafted for the modern gentleman. From casual days to formal events, find your perfect stride.
              </p>

              <p>
                Explore our range of <strong>Casual Sneakers & Formal Loafers</strong> and <strong>Comfortable Slide Sandals</strong> – designed for comfort, durability, and all-day confidence.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Premium Quality Footwear</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - SHOES & SANDALS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Premium shoes & sandals for every occasion
            </p>
          </div>
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/footwear/men/fproducts">
