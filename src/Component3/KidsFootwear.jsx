// KidsFootwear.jsx - Text Bottom Right Aligned
...
const KidsFootwear = () => {
  ...
  // Only TWO categories - Boy and Girl
  const categories = [
    {
      id: 1,
      title: "Boy",
  ...
  // Featured Products for Kids Footwear
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== KIDS' FOOTWEAR HERO SECTION - TWO BANNERS (BOY & GIRL) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - BOY & GIRL ONLY ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Kids' Footwear Collection</p>
          </div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              <h4 className="text-[#A67C52] font-bold tracking-[0.3em] sm:tracking-[0.5em] uppercase text-[8px] sm:text-[9px]">
                The Kids' Footwear Collection
              </h4>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Little Feet, <br />
                <span className="italic text-[#8B4513]">Big Adventures</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Kids' Footwear</strong>, we bring you durable and stylish shoes and sandals for your little ones. Designed for active play and everyday comfort.
              </p>

              <p>
                Explore our range of <strong>Shoes & Sandals for Boys and Girls</strong> – crafted with care for growing feet, combining fun designs with lasting quality.
              </p>
            </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-16 bg-[#EAE3DB]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/footwear/kids/fproducts">
