// HeelsWomenFootwear.jsx - Text Bottom Right Aligned
...
const HeelsWomenFootwear = () => {
  ...
  // Only TWO banners - Party Heels and Casual Heels
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Party and Casual
  const categories = [
    {
      id: 1,
      title: "Party",
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== WOMEN'S HEELS HERO SECTION - TWO BANNERS (PARTY & CASUAL) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - PARTY & CASUAL ONLY ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Women's Heels Collection</p>
          </div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              <h4 className="text-[#A67C52] font-bold tracking-[0.3em] sm:tracking-[0.5em] uppercase text-[8px] sm:text-[9px]">
                The Women's Heels Collection
              </h4>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Elevate Your <br />
                <span className="italic text-[#8B4513]">Style & Grace</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Women's Heels</strong>, we bring you stunning footwear crafted for every occasion. From glamorous parties to casual chic days, find your perfect pair.
              </p>

              <p>
                Explore our range of <strong>Dazzling Party Heels</strong> and <strong>Comfortable Casual Heels</strong> – designed to make you feel confident, beautiful, and effortlessly stylish.
              </p>
            </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Premium Quality Heels</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - PARTY & CASUAL HEELS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Premium heels for every occasion
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
            {featuredProducts.map((product) => (
              <div key={product.id} className="group flex flex-col">
                ...
                <Link
                  to="/footwear/women/heels/fproducts"
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/footwear/women/heels/fproducts">
...
export default HeelsWomenFootwear;