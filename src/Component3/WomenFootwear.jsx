// WomenFootwear.jsx - Text Bottom Right Aligned
...
const WomenFootwear = () => {
  ...
  // Only TWO banners - Heels and Flats
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Heels and Flats
  const categories = [
    {
      id: 1,
      title: "Heels",
  ...
  // Featured Products for Women Footwear
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== WOMEN'S FOOTWEAR HERO SECTION - TWO BANNERS (HEELS & FLATS) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - HEELS & FLATS ONLY ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Women's Footwear Collection</p>
          </div>
      ...
      {/* ====== WOMEN'S FOOTWEAR BRAND NARRATIVE ====== */}
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              <h4 className="text-[#A67C52] font-bold tracking-[0.3em] sm:tracking-[0.5em] uppercase text-[8px] sm:text-[9px]">
                The Women's Footwear Collection
              </h4>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Walk with <br />
                <span className="italic text-[#8B4513]">Grace & Style</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Women's Footwear</strong>, we bring you premium quality heels and flats crafted for the modern woman. From elegant evenings to casual days, find your perfect stride.
              </p>

              <p>
                Explore our range of <strong>Stiletto & Block Heels</strong> and <strong>Ballerina & Ethnic Flats</strong> – designed for comfort, durability, and all-day confidence.
              </p>
            </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - HEELS & FLATS */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Premium heels & flats for every occasion
            </p>
          </div>
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/footwear/women/fproducts">
