// ShoesMenFootwear.jsx - Text Bottom Right Aligned
...
const ShoesMenFootwear = () => {
  ...
  // Only TWO banners - Casual Shoes and Formal Shoes
  const banners = [
    {
      id: 1,
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== MEN'S SHOES HERO SECTION - TWO BANNERS (CASUAL & FORMAL) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - CASUAL & FORMAL ONLY ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Men's Shoes Collection</p>
          </div>
        ...
        <div className="max-w-[1400px] w-full grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            ...
            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Men's Shoes</strong>, we bring you premium quality footwear crafted for the modern gentleman. From casual days to formal events, find your perfect pair.
              </p>

              <p>
                Explore our range of <strong>Comfortable Casual Sneakers</strong> and <strong>Elegant Formal Shoes</strong> – designed for comfort, durability, and all-day confidence.
              </p>
            </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - CASUAL & FORMAL SHOES */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-16 bg-[#EAE3DB]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
            {featuredProducts.map((product) => (
              <div key={product.id} className="group flex flex-col">
                ...
                <Link
                  to="/footwear/men/shoes/fproducts"
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/footwear/men/shoes/fproducts">
...
export default ShoesMenFootwear;