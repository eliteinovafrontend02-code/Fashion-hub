...
const CasualWatchesAccessories = () => {
  ...
  const casualWatchesProducts = [
    {
      ...
      tag: "Bestseller",
      sub: "Premium Leather",
      description: "Timeless classic leather strap watch with a sleek dial design. The premium leather band offers comfort and durability, making it perfect for daily wear, office, and casual outings.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Premium Steel",
      description: "Sophisticated stainless steel chronograph watch with a bold dial. The durable steel bracelet and precise movement make it ideal for both casual and semi-formal occasions.",
    ...
    },
    {
      ...
      reviews: 1567,
      tag: "Popular",
      sub: "Durable Silicone",
      description: "Lightweight silicone sports watch perfect for active lifestyles. The comfortable silicone strap and durable design make it ideal for workouts, sports, and outdoor activities.",
    ...
    },
    {
      ...
      tag: "Classic",
      sub: "Genuine Leather",
      description: "Minimalist leather strap watch with a clean, elegant dial design. The genuine leather band and simple aesthetics make it perfect for minimalists and everyday wear.",
    ...
    },
    {
      ...
      tag: "New",
      sub: "Mesh Steel",
      description: "Elegant stainless steel mesh watch with a sophisticated look. The fine mesh bracelet and classic dial design make it suitable for both casual and formal occasions.",
    ...
    },
    {
      ...
      tag: "Essential",
      sub: "Soft Silicone",
      description: "Advanced silicone fitness watch with multiple health tracking features. The comfortable silicone strap and smart features make it perfect for fitness enthusiasts and health-conscious individuals.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Vintage Leather",
      description: "Vintage-style leather strap watch with a retro dial design. The distressed leather band and classic aesthetics give it a timeless appeal, perfect for vintage enthusiasts.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Diver Steel",
      description: "Professional diver-style stainless steel watch with exceptional water resistance. The robust steel bracelet and luminous dial make it ideal for water sports and adventurous activities.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Rugged Silicone",
      description: "Rugged silicone outdoor watch built for adventure. The durable silicone strap and tough construction make it perfect for camping, hiking, and outdoor expeditions.",
    ...
    },
    {
      ...
      tag: "Bestseller",
      sub: "Premium Leather",
      description: "Elegant leather dress watch with a sophisticated dial design. The premium leather band and refined aesthetics make it perfect for formal events, office wear, and special occasions.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Skeleton Steel",
      description: "Exquisite stainless steel skeleton watch showcasing the intricate movement inside. The transparent dial and premium steel bracelet create a stunning timepiece for watch enthusiasts.",
    ...
    },
    {
      ...
      tag: "Essential",
      sub: "Smart Silicone",
      description: "Modern silicone smart watch with advanced features and stylish design. The comfortable silicone strap and smart capabilities make it perfect for tech-savvy individuals and daily use.",
  ...
  const filters = ['all', 'Leather', 'Stainless Steel', 'Silicone'];
  const filteredProducts = activeFilter === 'all'
    ? casualWatchesProducts
    : casualWatchesProducts.filter(p => p.fabric === activeFilter);
        ...
        <section className="relative h-[30vh] md:h-[55vh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end justify-center pb-8 md:pb-20">
            <div className="text-center text-white px-4">
              <p className="text-amber-300 tracking-[0.2em] text-[8px] md:text-xs mb-2 md:mb-3 font-semibold">12 STYLISH WATCHES</p>
              <h1 className="text-2xl md:text-5xl lg:text-6xl font-serif font-light tracking-wide">The Casual Watch Edit</h1>
              <div className="h-[1px] w-8 md:w-12 bg-amber-400 mx-auto mt-3 md:mt-4 mb-3 md:mb-4"></div>
              <p className="text-xs md:text-base font-light tracking-wide max-w-lg mx-auto">Timeless accessories for every style</p>
            </div>
          </div>
        </section>
              ...
              <div className="md:w-2/5 p-6 md:p-12 overflow-y-auto flex flex-col bg-[#f4f3f0] md:border-l border-slate-100">
                <div className="mb-auto">
                  <p className="text-orange-700 font-bold text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 md:mb-4">
                    Casual Watch · {selectedProduct.fabric}
                  </p>
...
export default CasualWatchesAccessories;