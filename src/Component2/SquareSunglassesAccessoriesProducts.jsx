// SquareSunglassesAccessories.jsx
...
const SquareSunglassesAccessories = () => {
  ...
  const squareSunglassesProducts = [
    {
      id: 1,
      name: "Classic Metal Square",
      fabric: "Metal",
      price: 1599,
      oldPrice: 2699,
      rating: 4.8,
      ...
      tag: "Bestseller",
      sub: "Premium Metal",
      description: "Timeless classic square sunglasses with a sleek metal frame. The lightweight design and UV protection make them perfect for everyday wear, travel, and casual outings.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Premium Acetate",
      description: "Stylish tortoise shell square sunglasses with an acetate frame. The unique pattern and comfortable fit make them perfect for fashion-forward individuals.",
    ...
    },
    {
      ...
      tag: "Popular",
      sub: "Premium Metal",
      description: "Elegant silver square sunglasses with a polished metal frame. The sophisticated design and UV protection make them perfect for formal events and everyday style.",
    ...
    },
    {
      ...
      tag: "Classic",
      sub: "Premium Acetate",
      description: "Classic black square sunglasses with a durable acetate frame. The timeless design and comfortable fit make them essential for any wardrobe.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Luxury Metal",
      description: "Stunning rose gold square sunglasses with a premium metal frame. The luxurious finish and UV protection make them perfect for special occasions and fashion-forward looks.",
    ...
    },
    {
      ...
      tag: "New",
      sub: "Premium Acetate",
      description: "Trendy crystal clear square sunglasses with an acetate frame. The transparent design and modern style make them perfect for fashion enthusiasts.",
    ...
    {
      id: 7,
      name: "Gold Metal Vintage Square",
      fabric: "Metal",
      price: 1799,
      oldPrice: 2999,
      rating: 4.7,
      ...
      tag: "Bestseller",
      sub: "Premium Metal",
      description: "Vintage-inspired gold square sunglasses with a classic metal frame. The timeless design and UV protection make them perfect for retro fashion lovers.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Luxury Acetate",
      description: "Elegant marble pattern square sunglasses with a premium acetate frame. The unique design and comfortable fit make them perfect for making a style statement.",
    ...
    },
    {
      ...
      tag: "Essential",
      sub: "Premium Metal",
      description: "Minimalist black square sunglasses with a sleek metal frame. The clean design and UV protection make them perfect for everyday wear and minimalistic style.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Premium Acetate",
      description: "Stylish patterned square sunglasses with a durable acetate frame. The unique pattern and comfortable fit make them perfect for fashion-forward individuals.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Luxury Metal",
      description: "Exquisite gold rim vintage square sunglasses with premium metal frame. The luxurious design and UV protection make them perfect for special occasions and vintage lovers.",
    ...
    },
    {
      ...
      tag: "Popular",
      sub: "Premium Acetate",
      description: "Unique wood grain pattern square sunglasses with an acetate frame. The natural-inspired design and comfortable fit make them perfect for nature lovers and fashion enthusiasts.",
  ...
  const filteredProducts = activeFilter === 'all'
    ? squareSunglassesProducts
    : squareSunglassesProducts.filter(p => p.fabric === activeFilter);
        ...
        <section className="relative h-[30vh] md:h-[55vh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end justify-center pb-8 md:pb-20">
            <div className="text-center text-white px-4">
              <p className="text-amber-300 tracking-[0.2em] text-[8px] md:text-xs mb-2 md:mb-3 font-semibold">12 STYLISH SQUARE SUNGLASSES</p>
              <h1 className="text-2xl md:text-5xl lg:text-6xl font-serif font-light tracking-wide">The Square Sunglass Edit</h1>
              <div className="h-[1px] w-8 md:w-12 bg-amber-400 mx-auto mt-3 md:mt-4 mb-3 md:mb-4"></div>
              <p className="text-xs md:text-base font-light tracking-wide max-w-lg mx-auto">Bold style with a modern edge</p>
            </div>
          </div>
        </section>
              ...
              <div className="md:w-2/5 p-6 md:p-12 overflow-y-auto flex flex-col bg-[#f4f3f0] md:border-l border-slate-100">
                <div className="mb-auto">
                  <p className="text-orange-700 font-bold text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 md:mb-4">
                    Square Sunglasses · {selectedProduct.fabric}
                  </p>
                  ...
                  <div className="space-y-2 md:space-y-4 mb-4 md:mb-8">
                    ...
                    <div className="flex justify-between text-xs md:text-[13px] border-b border-slate-200/60 pb-2 md:pb-3">
                      ...
                      <span className="text-slate-950 font-bold">Square</span>
                    </div>
                  </div>
...
export default SquareSunglassesAccessories;