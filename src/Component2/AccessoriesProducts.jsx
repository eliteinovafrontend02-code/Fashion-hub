// AccessoriesProducts.jsx - Fixed Version
...
useEffect(() => {
  ...
  const getSizes = () => ["One Size"]; // Changed for accessories (watches, bags, sunglasses typically don't have S,M,L,XL)
    ...
    <>
      ...
      <div className="bg-[#f8f7f4] py-16 px-6 md:px-24 min-h-screen font-sans text-slate-900">
        ...
        <div className="mb-24 text-center">
          ...
          <h2 className="text-7xl font-serif italic uppercase tracking-tighter text-slate-800">Accessories Gallery</h2>
