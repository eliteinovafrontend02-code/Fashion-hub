// BanglesJewellery.jsx - Text Bottom Right Aligned
...
const BanglesJewellery = () => {
  ...
  // Only TWO banners - Traditional and Model Bangles
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Traditional and Model
  const categories = [
    {
      id: 1,
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== BANGLES HERO SECTION - TWO BANNERS (TRADITIONAL & MODEL) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - TRADITIONAL & MODEL BANGLES ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Bangles Collection</p>
          </div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              <h4 className="text-[#A67C52] font-bold tracking-[0.3em] sm:tracking-[0.5em] uppercase text-[8px] sm:text-[9px]">
                The Bangles Collection
              </h4>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Adorn Your <br />
                <span className="italic text-[#8B4513]">Wrist</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Jewellery</strong>, our bangles collection celebrates the perfect blend of tradition and trend. From timeless ethnic designs to contemporary fashion bangles, find the perfect adornment for your wrist.
              </p>

              <p>
                Explore our range of <strong>Traditional Bangles</strong> and <strong>Model Bangles</strong> – crafted with premium materials, intricate detailing, and lasting shine.
              </p>
            </div>

            <div className="pt-2 flex items-center gap-4">
              <div className="h-[1px] w-8 sm:w-10 md:w-12 bg-amber-900/30"></div>
              <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[#A67C52]">Handcrafted • Est. MMXXVI</span>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Tradition Meets Trend</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-16 bg-[#EAE3DB]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
            {featuredProducts.map((product) => (
              <div key={product.id} className="group flex flex-col">
                ...
                <Link
                  to="/jewellery/bangles/jproducts"
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/60 flex flex-col justify-end p-3 sm:p-5 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
                    <button
                      className="w-full bg-amber-600 hover:bg-amber-700 text-white py-2 sm:py-3 text-[9px] sm:text-[10px] uppercase tracking-[0.2em] sm:tracking-[0.3em] font-bold rounded-sm shadow-xl transition-colors"
                ...
                <div className="mt-5 sm:mt-6 md:mt-8 text-center px-2">
                  <p className="text-[9px] sm:text-[10px] text-amber-800 uppercase tracking-[0.2em] sm:tracking-[0.3em] font-bold mb-2">
                    {product.sub}
                  </p>

                  <h3 className="text-sm sm:text-base font-serif text-gray-900 group-hover:text-amber-700 transition-colors duration-300">
                    {product.name}
                  </h3>
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/jewellery/bangles/jproducts">
              <button className="group relative px-6 sm:px-8 md:px-12 py-3 sm:py-4 rounded-full overflow-hidden transition-all duration-500 shadow-md hover:shadow-amber-500/40">
                
                <span className="absolute inset-0 p-[1px] rounded-full bg-gradient-to-r from-amber-600 via-amber-500 to-red-600">
                  <span className="block w-full h-full bg-[#e9e0cc] rounded-full group-hover:bg-transparent transition-colors duration-500"></span>
                </span>

                <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-amber-600 via-amber-500 to-red-600 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out"></span>
                
                <span className="relative z-10 text-[9px] sm:text-[10px] md:text-[11px] font-bold uppercase tracking-[0.2em] sm:tracking-[0.3em] md:tracking-[0.4em] bg-gradient-to-r from-amber-800 to-red-900 bg-clip-text text-transparent group-hover:text-white transition-colors duration-500">
...
export default BanglesJewellery;