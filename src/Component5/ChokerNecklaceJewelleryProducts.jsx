...
const ChokerNecklaceJewellery = () => {
  ...
  const chokerNecklaceProducts = [
    // Wedding Grand Choker Models
    {
      id: 1,
      name: "Royal Gold Temple Choker",
      fabric: "Gold",
      price: 7999,
      oldPrice: 12499,
      rating: 4.9,
      ...
      tag: "Bestseller",
      sub: "Temple Design",
      description: "Magnificent royal gold temple choker with intricate temple motifs and traditional craftsmanship. This grand piece sits elegantly around the neck, perfect for weddings and auspicious ceremonies.",
    ...
    {
      id: 2,
      name: "Gold Kundan Bridal Choker",
      fabric: "Gold",
      price: 9999,
      oldPrice: 15499,
      rating: 4.9,
      ...
      tag: "Premium",
      sub: "Kundan Bridal",
      description: "Exquisite gold kundan bridal choker with stunning kundan work and intricate detailing. This luxurious piece is designed for the bride who wants to make a grand statement on her special day.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Pearl Bridal",
      description: "Elegant gold pearl bridal choker with genuine pearls and intricate gold work. This sophisticated piece adds a touch of grace and elegance to the bridal ensemble.",
    ...
    {
      id: 4,
      name: "Gold & Diamond Bridal Choker",
      fabric: "Diamond",
      price: 14999,
      oldPrice: 22999,
      rating: 4.9,
      ...
      tag: "Premium",
      sub: "Diamond Bridal",
      description: "Luxurious gold and diamond bridal choker with brilliant diamonds and exquisite gold work. This grand piece is designed for the bride who wants to shine on her wedding day.",
    ...
    {
      id: 5,
      name: "Gold Temple Bridal Choker",
      fabric: "Gold",
      price: 6999,
      oldPrice: 10999,
      rating: 4.8,
      ...
      tag: "Bestseller",
      sub: "Temple Bridal",
      description: "Beautiful gold temple bridal choker with traditional temple design and exquisite craftsmanship. Perfect for bridal wear and festive occasions.",
    ...
    {
      id: 6,
      name: "Gold Floral Bridal Choker",
      fabric: "Gold",
      price: 7499,
      oldPrice: 11999,
      rating: 4.7,
      ...
      tag: "Trending",
      sub: "Floral Design",
      description: "Stunning gold floral bridal choker with beautiful flower motifs and intricate gold work. The floral design adds a romantic touch to the bridal look.",
    ...
    // Regular Choker Models
    {
      ...
      tag: "Bestseller",
      sub: "Classic Design",
      description: "Classic gold choker necklace with a timeless design. The elegant gold finish and comfortable fit make it perfect for daily wear, office, and special occasions.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Filigree Work",
      description: "Beautiful silver filigree choker with intricate filigree work. The delicate silver finish and detailed craftsmanship make it perfect for traditional and contemporary wear.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Diamond Cut",
      description: "Luxurious diamond cut gold choker with brilliant facets that catch the light. The exquisite choker features diamond-cut links that sparkle like diamonds.",
    ...
    },
    {
      ...
      tag: "Classic",
      sub: "Silver & Pearl",
      description: "Elegant silver pearl choker with genuine pearls and silver finish. The beautiful combination creates a sophisticated look perfect for parties and special occasions.",
    ...
    },
    {
      ...
      description: "Gold minimalist choker with a sleek, modern design. The simple yet elegant gold finish makes it perfect for daily wear and minimalist fashion lovers.",
    ...
    },
    {
      ...
      tag: "Sale",
      sub: "Diamond Choker",
      description: "Beautiful gold and diamond choker with brilliant diamonds and elegant gold work. This stunning piece is perfect for making a style statement on special occasions.",
  ...
  const filteredProducts = activeFilter === 'all'
    ? chokerNecklaceProducts
    : chokerNecklaceProducts.filter(p => p.fabric === activeFilter);
        ...
        <section className="relative h-[30vh] md:h-[55vh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end justify-center pb-8 md:pb-20">
            <div className="text-center text-white px-4">
              <p className="text-amber-300 tracking-[0.2em] text-[8px] md:text-xs mb-2 md:mb-3 font-semibold">12 ELEGANT CHOKERS</p>
              <h1 className="text-2xl md:text-5xl lg:text-6xl font-serif font-light tracking-wide">The Choker Edit</h1>
              <div className="h-[1px] w-8 md:w-12 bg-amber-400 mx-auto mt-3 md:mt-4 mb-3 md:mb-4"></div>
              <p className="text-xs md:text-base font-light tracking-wide max-w-lg mx-auto">Elevate your style with timeless choker designs</p>
            </div>
          </div>
        </section>
        ...
        <div className="sticky top-0 z-20 bg-[#faf8f5]/95 backdrop-blur-sm border-b border-gray-200 py-3 md:py-4 px-3 md:px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-center text-[9px] md:text-[10px] text-gray-400 mt-2 md:mt-3 tracking-wide">
              {filteredProducts.length} {filteredProducts.length === 1 ? 'choker' : 'chokers'} available
            </p>
          </div>
        </div>
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="mt-2 md:mt-3 px-0.5 md:px-1">
                  <p className="text-[7px] md:text-[9px] text-amber-700 uppercase tracking-[0.15em] md:tracking-[0.2em] font-semibold mb-0.5">Choker · {product.fabric}</p>
              ...
              <div className="md:w-2/5 p-6 md:p-12 overflow-y-auto flex flex-col bg-[#f4f3f0] md:border-l border-slate-100">
                <div className="mb-auto">
                  <p className="text-orange-700 font-bold text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 md:mb-4">
                    Choker Necklace · {selectedProduct.fabric}
                  </p>
                  ...
                  <div className="space-y-2 md:space-y-4 mb-4 md:mb-8">
                    ...
                    <div className="flex justify-between text-xs md:text-[13px] border-b border-slate-200/60 pb-2 md:pb-3">
                      ...
                      <span className="text-slate-950 font-bold">Choker</span>
                    </div>
                  </div>
...
export default ChokerNecklaceJewellery;