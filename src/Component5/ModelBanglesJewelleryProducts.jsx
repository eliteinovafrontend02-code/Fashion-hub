...
const ModelBanglesJewellery = () => {
 ...
 const modelBanglesProducts = [
    ...
    {
      id: 1,
      name: "Gold Royal Peacock Bangles",
      fabric: "Gold",
      price: 4999,
      oldPrice: 7999,
      rating: 4.9,
      ...
      tag: "Bestseller",
      sub: "Royal Peacock",
      description: "Majestic gold peacock-inspired designer bangles with intricate feather motifs and royal craftsmanship. This grand bridal set is perfect for weddings and grand celebrations.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Polki Royal",
      description: "Exquisite gold polki royal bangles with uncut diamonds and traditional polki work. This luxurious set embodies royal elegance and is perfect for the modern queen.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Ruby Enamel",
      description: "Stunning gold ruby enamel bangles with ruby stones and intricate meenakari work. The rich red enamel adds a regal touch, making them perfect for bridal wear.",
    ...
    {
      id: 4,
      name: "Gold Emerald Royal Bangles",
      fabric: "Gold",
      price: 7999,
      oldPrice: 12499,
      rating: 4.9,
      ...
      tag: "Premium",
      sub: "Emerald Royal",
      description: "Luxurious gold emerald royal bangles with premium emerald stones and intricate gold work. This grand set is designed for the bride who desires timeless elegance.",
    ...
    {
      id: 5,
      name: "Gold Lotus Temple Bangles",
      fabric: "Gold",
      price: 4499,
      oldPrice: 6999,
      rating: 4.8,
      ...
      tag: "Bestseller",
      sub: "Lotus Temple",
      description: "Beautiful gold lotus temple bangles with sacred lotus motifs and temple-inspired design. The divine lotus pattern adds spirituality and grace to any auspicious occasion.",
    ...
    {
      id: 6,
      name: "Gold Floral Filigree Bangles",
      fabric: "Gold",
      price: 3999,
      oldPrice: 6499,
      rating: 4.7,
      ...
      tag: "Classic",
      sub: "Floral Filigree",
      description: "Elegant gold floral filigree bangles with delicate filigree work and floral patterns. The intricate craftsmanship makes them perfect for traditional and contemporary wear.",
    ...
    {
      id: 7,
      name: "Gold Sleek Modern Bangles",
      fabric: "Gold",
      price: 1299,
      oldPrice: 1999,
      rating: 4.8,
      ...
      tag: "Bestseller",
      sub: "Sleek Modern",
      description: "Sleek modern gold bangles with a minimalist contemporary design. The smooth finish and lightweight construction make them ideal for everyday elegance and special occasions.",
    ...
    {
      id: 8,
      name: "Silver Vintage Designer Bangles",
      fabric: "Silver",
      price: 999,
      oldPrice: 1599,
      rating: 4.7,
      ...
      tag: "Trending",
      sub: "Vintage Silver",
      description: "Charming silver vintage designer bangles with antique finish and intricate traditional patterns. The vintage design adds a touch of old-world charm to modern outfits.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Radiant Cut",
      description: "Exquisite gold radiant cut bangles with brilliant faceted design that catches light beautifully. The radiant cut links create a stunning sparkle effect perfect for festive occasions.",
    ...
    {
      id: 10,
      name: "Silver Enamel Flower Bangles",
      fabric: "Silver",
      price: 1199,
      oldPrice: 1899,
      rating: 4.6,
      ...
      tag: "Classic",
      sub: "Enamel Flower",
      description: "Beautiful silver enamel flower bangles with colorful floral enamel work and delicate silver craftsmanship. The vibrant floral designs make them perfect for festive celebrations.",
    ...
    {
      id: 11,
      name: "Gold Contemporary Minimal Bangles",
      fabric: "Gold",
      price: 1099,
      oldPrice: 1699,
      rating: 4.5,
      reviews: 1023,
      tag: "Essential",
      sub: "Contemporary Minimal",
      description: "Gold contemporary minimal bangles with a clean, modern aesthetic. The pure gold finish and minimalist design make them essential for the modern fashion-forward individual.",
    ...
    },
    {
      ...
      reviews: 2456,
      tag: "Sale",
      sub: "Diamond Designer Set",
      description: "Elegant gold and Diamond designer bangles set with precious Diamond stones and contemporary gold design. This stunning set creates a modern statement with a touch of iridescent beauty.",
