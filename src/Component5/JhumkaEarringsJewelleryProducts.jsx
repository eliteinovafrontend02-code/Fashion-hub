...
const JhumkaEarringsJewellery = () => {
  ...
  const jhumkaProducts = [
    {
      ...
      reviews: 2345,
      tag: "Bestseller",
      sub: "Traditional Gold",
      description: "Beautiful traditional gold jhumkas with intricate temple design. The pure gold finish and traditional craftsmanship make these earrings perfect for weddings, festivals, and cultural celebrations.",
    ...
    },
    {
      ...
      tag: "Trending",
      sub: "Chandbali Style",
      description: "Stunning silver chandbali jhumkas with a contemporary twist. The pure silver finish and elegant design make these earrings perfect for parties, weddings, and festive occasions.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Diamond Jhumkas",
      description: "Luxurious diamond studded jhumkas with brilliant diamonds. The exquisite design and sparkling diamonds make these earrings a true statement piece for weddings and grand celebrations.",
    ...
    },
    {
      ...
      tag: "Classic",
      sub: "Kundan Work",
      description: "Elegant gold kundan jhumkas with intricate kundan work. The beautiful gold finish and kundan detailing make these earrings perfect for weddings, festivals, and traditional events.",
    ...
    },
    {
      ...
      tag: "Popular",
      sub: "Temple Design",
      description: "Beautiful silver temple jhumkas with traditional temple motifs. The pure silver finish and cultural design make these earrings perfect for daily wear and festive occasions.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Diamond Drop",
      description: "Exquisite diamond drop jhumkas with a stunning drop design. The brilliant diamonds and elegant design make these earrings perfect for weddings, receptions, and grand celebrations.",
    ...
    },
    {
      ...
      tag: "Bestseller",
      sub: "Gold & Pearl",
      description: "Elegant gold pearl jhumkas with genuine pearls. The beautiful combination of gold and pearls creates a sophisticated look perfect for weddings, festivals, and special occasions.",
    ...
    },
    {
      ...
      tag: "New",
      sub: "Meenakari Work",
      description: "Beautiful silver meenakari jhumkas with colorful enamel work. The silver finish and vibrant meenakari detailing make these earrings perfect for festive celebrations and cultural events.",
    ...
    },
    {
      ...
      tag: "Premium",
      sub: "Diamond & Gold",
      description: "Luxurious diamond and gold jhumkas with a stunning combination. The brilliant diamonds and gold finish make these earrings a true masterpiece for weddings and grand celebrations.",
    ...
    },
    {
      ...
      tag: "Classic",
      sub: "Filigree Work",
      description: "Beautiful gold filigree jhumkas with intricate filigree work. The delicate gold finish and detailed craftsmanship make these earrings perfect for weddings and traditional events.",
    ...
    },
    {
      ...
      tag: "Essential",
      sub: "Oxidized Silver",
      description: "Stylish silver oxidized jhumkas with a vintage look. The oxidized finish and traditional design make these earrings perfect for casual wear, festivals, and bohemian style.",
    ...
    },
    {
      ...
      tag: "Sale",
      sub: "Mini Diamond",
      description: "Beautiful diamond mini jhumkas with a delicate design. The brilliant diamonds and compact size make these earrings perfect for daily wear, office, and casual outings.",
  ...
  const filteredProducts = activeFilter === 'all'
    ? jhumkaProducts
    : jhumkaProducts.filter(p => p.fabric === activeFilter);
        ...
        <section className="relative h-[30vh] md:h-[55vh] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end justify-center pb-8 md:pb-20">
            <div className="text-center text-white px-4">
              <p className="text-amber-300 tracking-[0.2em] text-[8px] md:text-xs mb-2 md:mb-3 font-semibold">12 TRADITIONAL JHUMKAS</p>
              <h1 className="text-2xl md:text-5xl lg:text-6xl font-serif font-light tracking-wide">The Jhumka Edit</h1>
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="mt-2 md:mt-3 px-0.5 md:px-1">
                  <p className="text-[7px] md:text-[9px] text-amber-700 uppercase tracking-[0.15em] md:tracking-[0.2em] font-semibold mb-0.5">Jhumka · {product.fabric}</p>
              ...
              <div className="md:w-2/5 p-6 md:p-12 overflow-y-auto flex flex-col bg-[#f4f3f0] md:border-l border-slate-100">
                <div className="mb-auto">
                  <p className="text-orange-700 font-bold text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] mb-2 md:mb-4">
                    Jhumka Earrings · {selectedProduct.fabric}
                  </p>
                  ...
                  <div className="space-y-2 md:space-y-4 mb-4 md:mb-8">
                    ...
                    <div className="flex justify-between text-xs md:text-[13px] border-b border-slate-200/60 pb-2 md:pb-3">
                      ...
                      <span className="text-slate-950 font-bold">Jhumka</span>
                    </div>
                  </div>
...
export default JhumkaEarringsJewellery;