// NecklaceJewellery.jsx - Text Bottom Right Aligned
...
const NecklaceJewellery = () => {
  ...
  // Only TWO banners - Chain and Choker
  const banners = [
    {
      id: 1,
  ...
  // Only TWO categories - Chain and Choker
  const categories = [
    {
      id: 1,
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* ====== NECKLACE HERO SECTION - TWO BANNERS (CHAIN & CHOKER) ====== */}
      ...
      {/* ====== CIRCULAR CATEGORY SECTION - CHAIN & CHOKER NECKLACE ====== */}
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 bg-[#f0ecdd] relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 text-xs sm:text-sm tracking-wider">Necklace Collection</p>
          </div>
          ...
          <div className="order-2 lg:order-1 space-y-4 sm:space-y-6 py-4">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#2D241E] leading-tight font-light">
                Elevate Your <br />
                <span className="italic text-[#8B4513]">Style</span>
              </h2>
            </div>

            <div className="space-y-3 sm:space-y-5 text-[#544A42] text-sm sm:text-base md:text-lg leading-relaxed font-light">
              <p>
                At <strong className="text-[#2D241E] font-medium">Fashion Hub Jewellery</strong>, our necklace collection celebrates timeless beauty and contemporary design. From classic chains to trendy chokers, find the perfect piece for every neckline and occasion.
              </p>

              <p>
                Explore our range of <strong>Chain Necklaces</strong> and <strong>Choker Necklaces</strong> – crafted with premium materials, exquisite detailing, and lasting quality.
              </p>
            </div>

            <div className="pt-2 flex items-center gap-4">
              <div className="h-[1px] w-8 sm:w-10 md:w-12 bg-amber-900/30"></div>
              <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[#A67C52]">Premium Quality • Est. MMXXVI</span>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[700px] aspect-[16/10] bg-[#EBE2D7] p-2 sm:p-3 md:p-5 rounded-[20px] sm:rounded-[30px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] group transition-all duration-700 hover:shadow-amber-200/30">
              ...
              <div className="absolute -bottom-2 sm:-bottom-4 -left-2 sm:-left-4 px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg border border-white hidden md:block">
                <p className="text-[#8B4513] font-serif italic text-xs sm:text-sm tracking-wide">Timeless Elegance</p>
              </div>
            </div>
          </div>
      ...
      {/* 🔥 FEATURED COLLECTIONS - CHAIN & CHOKER NECKLACE */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-500 mt-4 sm:mt-6 font-light italic tracking-widest text-xs sm:text-sm">
              Timeless designs for every neckline
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10">
            {featuredProducts.map((product) => (
              <div key={product.id} className="group flex flex-col">
                ...
                <Link
                  to="/jewellery/necklace/jproducts"
          ...
          <div className="mt-16 sm:mt-20 text-center">
            <Link to="/jewellery/necklace/jproducts">
...
export default NecklaceJewellery;